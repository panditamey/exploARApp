package com.ameypandit.exploar.geography;
...
public class Geo1Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArFragment = (com.google.ar.sceneform.ux.ArFragment) getSupportFragmentManager().findFragmentById(R.id.geo1frag);
        setUpModel();
        setUpPlane();
