package com.ameypandit.exploar.history;
...
public class History1Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArFragment = (com.google.ar.sceneform.ux.ArFragment) getSupportFragmentManager().findFragmentById(R.id.his1frag);
        setUpModel();
        setUpPlane();
    }
    ...
    private void setUpModel() {
        ModelRenderable.builder()
                .setSource(this,R.raw.colosseum)
                .build()
