package com.ameypandit.exploar.sports;
...
public class Sports1Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArFragment = (com.google.ar.sceneform.ux.ArFragment) getSupportFragmentManager().findFragmentById(R.id.sports1frag);
        setUpModel();
        setUpPlane();
    }
